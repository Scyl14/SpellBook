...
class TextInputView:
    def __init__(self, stdscr: window, title=None, input_len=100):
        self.stdscr = stdscr
        self.title = title
        self.curwindow = stdscr.derwin(9, 1)
...
class RemoteInjectionView:
    ...
    def exec(self):
        ...
        enum_menu = Menu(self.curwindow, 9, 0, list(self.enum_types.keys()))
        ...
        if "callback_function" in self.enum_types[enumeration_type]:
            ...
            type_menu = Menu(self.curwindow, 9, 0, list(self.injection_types.keys()))
...
def main(stdscr: window):
    stdscr.border()
    # Begin banner
    stdscr.addstr(1, 1, "  _________             .__  .__ __________               __    ")
    stdscr.addstr(2, 1, " /   _____/_____   ____ |  | |  |\\______   \\ ____   ____ |  | __")
    stdscr.addstr(3, 1, " \_____  \\\\____ \\_/ __ \\|  | |  | |    |  _//  _ \\ /  _ \\|  |/ /")
    stdscr.addstr(4, 1, " /        \\  |_> >  ___/|  |_|  |_|    |   (  <_> |  <_> )    < ")
    stdscr.addstr(5, 1, "/_______  /   __/ \\___  >____/____/______  /\\____/ \\____/|__|_ \\")
    stdscr.addstr(6, 1, "        \\/|__|        \\/                 \\/                   \\/")
    # End banner
    stdscr.refresh()
